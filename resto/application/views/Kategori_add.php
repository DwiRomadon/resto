              ...
              <form method="post">
                <fieldset>
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="Nama kategori" type="text" required="" name="nama">
                  </div>
                  <div class="form-group">
                      <label>Catatan kategori</label>
                      <textarea class="form-control" placeholder="catatan kategori" rows="3" name="catatan"></textarea>
                  </div>
                </fieldset>
                <div>
