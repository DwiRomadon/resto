<div class="row">
		<div class="col-md-12 panel-info">
		  	...
		  	<div class="content-box-large box-with-header">
			              ...
			              <a class="btn btn-md btn-primary" href="<?php echo base_url('profil');?>">
			                <i class="fa fa-user"></i> Profil
			              </a>

			              <a class="btn btn-md btn-primary" href="<?php echo base_url('sistem');?>">
			                <i class="fa fa-user"></i> Pengaturan sistem
			              </a>
			             
			              <a class="btn btn-md btn-primary" href="<?php echo base_url('logout');?>">
