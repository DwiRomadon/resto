	...
	<div class="col-md-6 panel-info">
      ...
      <?php endif; ?>
  		...
  		<div class="content-box-large heading">
			<div class="panel-title">Tambah Data karyawan</div>
              ...
              <form method="post">
                <fieldset>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="(hanya angka) Contoh : 089123819" type="number" required="" name="telp">
                  </div>
                  <div class="form-group">
                    <label>Jabatan</label>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="input username" type="text" required="" name="username">
                  </div>
                  <div class="form-group">
                    <label>Password</label>
                    <input class="form-control" placeholder="input password" type="text" required="" name="password">
                  </div>
                </fieldset>
                <div>
