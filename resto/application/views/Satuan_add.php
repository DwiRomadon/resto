              ...
              <form method="post">
                <fieldset>
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="Contoh : Kilogram" type="text" required="" name="nama">
                  </div>
                  <div class="form-group">
                      <label>Catatan satuan</label>
                      <textarea class="form-control" placeholder="catatan satuan" rows="3" name="catatan"></textarea>
                  </div>
                </fieldset>
                <div>
